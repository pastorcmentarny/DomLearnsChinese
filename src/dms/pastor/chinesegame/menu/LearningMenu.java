...
public final class LearningMenu extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button miniLessonButton = findViewById(R.id.lessonButton);
        miniLessonButton.setOnClickListener(this);
        Button learningTipsButton = findViewById(R.id.learningTipsButton);
        ...
        Button dictButton = findViewById(R.id.dictButton);
        ...
        dialog = new AlertDialog.Builder(this).setTitle(R.string.learning_title).setItems(R.array.test_dialog, (dialoginterface, i) -> {
            ...
            switch (i) {
                ...
                case 1:
                    ...
                    alertBox.setPositiveButton(getString(R.string.go2www), (di, arg) -> {
